...
type Pokemon struct {
	AppModel
	PokemonName string `json:"pokemon_name" validate:"required,one_of=D Pikachu Bulbasaur Charmander Squirtle,min=2,max=100"`
	...
	Attack      string `json:"attack" validate:"required,one_of=Thunderbolt Ember Vine_Whip Water_Gun,min=2,max=100" gorm:"not null"`
}
