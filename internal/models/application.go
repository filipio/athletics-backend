...
func Paginate[T any](query *gorm.DB, r *http.Request, paginationOptions *httpio.PaginationParams, mapResponseFunc func(T) any, queryInstance any) (*httpio.PaginatedResponse, error) {
	...
	return httpio.BuildPaginatedResponse(responseRecords, totalCount, paginationParams), nil
}

func PaginateQuery(db *gorm.DB, paginationParams *httpio.PaginationParams) *gorm.DB {
